...
/*
Costum Created Buggy Class
*/
public class BuggySwedishSocialSecurityNumberWrongSSN {
    private SSNHelper helper;
    private String ssn;
    
    public BuggySwedishSocialSecurityNumberWrongSSN(String stringInput, SSNHelper helper) throws Exception {
        this.helper = helper;
    ...
    public String getSSN() {
        // BUG: Returns modified SSN instead of original
