...
public class BuggySwedishSocialSecurityNumberNoTrimTest {
    ...
    public void shouldAcceptValidSSN() throws Exception {
        ...
        BuggySwedishSocialSecurityNumberNoTrim ssn = new BuggySwedishSocialSecurityNumberNoTrim("900101-0017", helper);
    ...
    public void shouldThrowExceptionWhenLengthValidationFails() throws Exception {
        ...
        assertThrows(Exception.class, () -> {
            new BuggySwedishSocialSecurityNumberNoTrim("900101-0017", helper);
        });
    }
