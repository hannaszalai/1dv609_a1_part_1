...
public class BuggySwedishSocialSecurityNumberNoLuhnTest {
    ...
    public void shouldAcceptValidSSN() throws Exception {
        ...
        BuggySwedishSocialSecurityNumberNoLuhn ssn = new BuggySwedishSocialSecurityNumberNoLuhn("900101-0017", helper);
    ...
    public void shouldThrowExceptionWhenLuhnValidationFails() throws Exception {
        ...
        when(helper.isValidMonth("01")).thenReturn(true);
        when(helper.isValidDay("01")).thenReturn(true);
        when(helper.luhnIsCorrect("900101-0017")).thenReturn(false); // this
    ...
    public void shouldTrimInputBeforeValidation() throws Exception {
        ...
        BuggySwedishSocialSecurityNumberNoLuhn ssn = new BuggySwedishSocialSecurityNumberNoLuhn(inputWithSpaces, helper);
